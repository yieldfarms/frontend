...
// Import contract ABIs like so:
// import FooBarABI from './abi/foobar.json
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
  supportedPools,
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    // this.foobar = new this.web.eth.Contract(FooBarABI)
  ...
  setProvider(provider, networkId) {
    ...
    // setProvider(this.foobar, contractAddress.foo[networkId])
  }

  setDefaultAccount(account) {
    // If you are sending any txs with your contract,
    // add it here.
    // this.foobar.options.from = account
  }
